        ...
        Column(
            ...
            Row(
                ...
                TextButton(onClick = onCallClick) {
                    Text("Ara", color = KalkanBlue, fontWeight = FontWeight.SemiBold)
                }
                TextButton(onClick = onSmsClick) {
                    Text("SMS", color = KalkanBlue, fontWeight = FontWeight.SemiBold)
                }
                TextButton(onClick = onWhatsAppClick) {
                    Text("WhatsApp", color = KalkanBlue, fontWeight = FontWeight.SemiBold)
                }
            }
        }
    }
